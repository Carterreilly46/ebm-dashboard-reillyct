...
**Population (P):** Employees at all levels experiencing organizational changes (restructuring, mergers, strategic shifts)

**Intervention (I):** Increased frequency of executive communications (video updates, town halls, Q&A sessions, email briefings)

**Comparison (C):** Current sporadic/ad-hoc executive communication approach during organizational transitions

**Outcomes (O):** 
- 80% of employees report clear role understanding (vs. 45% baseline)
- Maintain 90% productivity levels during change (vs. typical 60-70% drop)
- Achieve 7.5/10 employee confidence in leadership (vs. 4.2/10 baseline)
- Keep voluntary turnover at normal 12% (vs. 18% during poorly managed change)

**Context (C):** During major organizational changes including restructuring, mergers, leadership transitions, and strategic pivots across all departments and locations

**Organization Context:** Large organization experiencing frequent changes (restructuring, mergers, leadership transitions) with need to maintain employee clarity and productivity

**Why This Matters:** Infrequent executive communication during organizational changes causes role confusion, productivity drops of 30-40%, turnover spikes to 18% (vs. normal 12%), increased anxiety, and failed change initiatives that cost millions in lost productivity and talent

**Success Vision:** Regular, clear executive communications (2-3x per week) that maintain 80% role clarity, 90% productivity levels, and employee confidence at 7.5/10, enabling successful organizational transitions with minimal disruption
...
1. [Practitioner 1: Change Management Consultant - Expert in executive communications during M&A]
2. [Practitioner 2: Chief Communications Officer - Led 3+ major organizational transitions]
3. [Practitioner 3: HR Executive - Specializes in employee engagement during change]
4. [Practitioner 4: Internal Communications Director - Designed communication cadences]
5. [Practitioner 5: Organizational Development Leader - Measured role clarity initiatives]
6. [Practitioner 6: Executive Coach - Advises C-suite on communication effectiveness]

**My Progress Notes:**
[Target: Change management professionals, internal comms experts, HR leaders who've managed communication during organizational transitions. Key biases: Confirmation bias (only reporting successes), survivorship bias (ignoring failed implementations)]
...
**My Key Search Terms:**
- Primary terms: "executive communication" AND "organizational change", "leadership communication frequency", "role clarity" AND "change management"
- Secondary terms: "employee uncertainty" AND "productivity", "communication cadence" AND "transition", "town hall" AND effectiveness
- Best performing query: (TI("executive communication*") OR AB("leadership communication")) AND (TI("organizational change") OR AB("role clarity" OR "employee productivity"))
...
1. [Data Source 1: Employee engagement survey data during past organizational changes]
2. [Data Source 2: Productivity metrics (output per FTE) during transition periods]
3. [Data Source 3: Voluntary turnover rates correlated with communication frequency]

**My Progress Notes:**
[Looking for HR analytics on employee sentiment during changes, productivity tracking systems, and internal communication platform usage data. Key limitation: Historical data may not track communication frequency systematically]
...
1. [Stakeholder Group 1: Frontline employees - Online survey - Target 70% response rate]
2. [Stakeholder Group 2: Middle managers - Semi-structured interviews - 15-20 participants]
3. [Stakeholder Group 3: HR/Internal Comms teams - Focus groups - 8-12 participants]

**My Progress Notes:**
[Employees may over-report desire for communication (social desirability). Managers may blame lack of exec comms to deflect own communication gaps. Need anonymous surveys and triangulation across groups]
...
[Expected patterns: Scientific evidence shows optimal communication frequency; practitioners validate what works in practice; organizational data reveals current gaps; stakeholders confirm need for clarity. Watch for: Contradictions between ideal frequency (research) vs. realistic capacity (organizational data)]

**My Solution Recommendation:**
[Implement structured executive communication cadence: 2-3 weekly messages during major changes, bi-weekly town halls, 48-hour Q&A response standard, pulse surveys to monitor role clarity, with success measured by 80% clarity scores and 90% productivity maintenance]
